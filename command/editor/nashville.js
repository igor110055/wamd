...
module.exports = {
    name: "nashville",
    alias: ["nashv", 'ville'],
    use: "*Example :* Reply Image and Send Caption !x2pro",
    category: "filter",
    async exec({ sock, msg, args }) {
		...
		try {
            ...
            if (quoted && isQMed) {
                ...
                await sock.sendMessage(msg.from, { image: { url: `https://api.lolhuman.xyz/api/filter/nashville?apikey=Papah-Chan&img=${lolhuman.data.result}` } }, { quoted: msg });
            } else if (isMed) {
