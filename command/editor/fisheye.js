...
module.exports = {
    name: "fisheye",
    alias: ["fshy", 'fsh'],
    use: "*Example :* Reply Image and Send Caption !fisheye",
    category: "editor",
    async exec({ sock, msg, args }) {
		...
		try {
            ...
            if (quoted && isQMed) {
                ...
                await sock.sendMessage(msg.from, { image: { url: `https://api.lolhuman.xyz/api/editor/fisheye?apikey=Papah-Chan&img=${lolhuman.data.result}` } }, { quoted: msg });
            } else if (isMed) {
