...
module.exports = {
    name: "lofi",
    alias: ["lof"],
    use: "*Example :* Reply Image and Send Caption !lofi",
    category: "filter",
    async exec({ sock, msg, args }) {
		...
		try {
            ...
            if (quoted && isQMed) {
                ...
                await sock.sendMessage(msg.from, { image: { url: `https://api.lolhuman.xyz/api/filter/lofi?apikey=Papah-Chan&img=${lolhuman.data.result}` } }, { quoted: msg });
            } else if (isMed) {
